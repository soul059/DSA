...
Node<int>* middleOfLL(LinkedList<int>& ll) {
    Node<int>* slow = ll.getHead();
    Node<int>* fast = ll.getHead();
    
    if (!slow) return nullptr; // If the list is empty
...
int main(){
    ...
    list.display();
    Node<int>* middleNode = middleOfLL(list);
    if (middleNode) {
