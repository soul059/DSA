...
Node<int>* itrativeReverse(Node<int>* head) {
...
Node<int>* recursiveReverse(Node<int>* head) {
    ...
    Node<int>* newHead = recursiveReverse(head->next); // Reverse the rest of the list
...
int main(){
    ...
    cout << "Original List: ";
    list.display();
    Node<int>* reversedHead = itrativeReverse(list.getHead());
